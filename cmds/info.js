...
.addField(ph[9], Comp.addCommas(Comp.client.users.size) + ` ${ph[12]} (${Comp.declOfNum(Comp.client.stats.users.users, ph[10], 1)}, ${Comp.declOfNum(Comp.client.stats.bots, ph[11], 1)})`, true)
